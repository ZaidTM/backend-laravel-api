    ...
    <main id="main">
        ...
        <section class="inner-page">
            <div class="container">
                ...
                <form action="{{ route('guardiannews') }}" id="NewFilterForm" method="get">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-2 mt-4 mt-md-0">
                            ...
                            <a href="{{ route('guardiannews') }}" type="submit" class="btn btn-danger p-3 mt-4">Reset</a>
                        </div>
                    </div>
                </form>
                                    ...
                                    @forelse($all_articles->results as $all_article)
                                        ...
                                        <div class="card cardsearch">
                                            <div class="card-body">
                                                ...
                                                <a href="{{ ($all_article->webUrl) ? $all_article->webUrl : '' }}"
                                                   target="_blank" class="text-white btn btn-dark"><b class="News_Heading">Read More</b>
                                                </a>
                                            </div>
                                        </div>
